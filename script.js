console.log("Wake up, Samurai! We've got a city to burn!");
// selectors
...
function addExpense(event) {
    event.preventDefault();
    console.log("The more you click me, the more broke you'll be");
    addExpenseButton.addEventListener("click", first);
function first(e){
